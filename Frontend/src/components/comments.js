...
class comment extends React.Component {
    ...
    editComButton(id,msg,email,rate){
        if(localStorage.getItem('email')){ //localStorage.getItem('userEmail') session
            if(email===localStorage.getItem('email')){ //localStorage.getItem('userEmail') session
    ...
    form_sub = e => {
        ...
        if(isValid){
            if(localStorage.getItem('email')){
                const data ={ comment:this.state.comment,name:localStorage.getItem('name'),email:localStorage.getItem('email'),product:localStorage.getItem('itemId'),rating:this.state.rating }
                if(this.state.cId){
                ...
                <div class="justify-content-center">
                    ...
                    <form autoComplete="off" onSubmit={this.form_sub}>
                        ...
                        <div className="form-group row">
                            <label className="col-md-4 col-form-label text-md-right">Product</label>
